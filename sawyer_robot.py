...
class Sawyer:
    def __init__(self):
        ...
        self.T_R=[self.T_R_01, self.T_R_12, self.T_R_23, self.T_R_34, self.T_R_45, 
                self.T_R_56, self.T_R_67, self.T_R_89, self.T_R_9e]
    ...
    def inverse_kinematics(self, limb, coordinates, orientation):
        ...
        quaternion = tf.transformations.quaternion_from_euler(math.radians(orientation[0]), 
                math.radians(orientation[1]), math.radians(orientation[2]))
